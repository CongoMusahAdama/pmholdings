...
export const navPages: NavPage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'radio', label: 'Radio Shows Hosted' },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'upcoming', label: 'March Pint · December Dine' },
  ...
  {
    to: '/pm-entertainment',
    label: 'PM Entertainment Consult',
    description: 'Events, PR, activations, talent, and branding — Takoradi.',
    sections: [
      { id: 'overview', label: 'What We Do' },
      { id: 'services', label: 'Capabilities' },
      { id: 'lineup', label: 'January Afrin · September Finest' },
  ...
  },
  {
    to: '/cyto',
    label: 'CYTO GH',
    description: 'Nurture, groom, and polish every gift.',
    sections: [
      { id: 'pillars', label: 'Nurture · Groom · Polish' },
      { id: 'mission', label: 'What Cyto Does' },
      { id: 'process', label: 'The Roadmap' },
      { id: 'focus', label: 'Who We Develop' },
      { id: 'artiste', label: 'Bluk' },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'upcoming', label: 'May · October · November' },
